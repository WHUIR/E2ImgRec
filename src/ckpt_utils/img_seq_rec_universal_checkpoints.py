...
class UniversalCheckpoint(ModelCheckpoint):
    ...
    def add_argparse_args(parent_args):
        ...
        parser.add_argument('--save_ckpt_path', default='../../ckpt/temp/', type=str)
        parser.add_argument('--load_ckpt_path', default='../../ckpt/temp/', type=str)
        parser.add_argument('--filename', default='model-{epoch:02d}-{step:d}', type=str)
        parser.add_argument('--save_last', default=True)
        parser.add_argument('--save_top_k', default=100, type=float)
